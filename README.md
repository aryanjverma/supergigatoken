...
*Train a 50k tokenizer in seconds, a 50k SuperBPE in minutes, then encode at hundreds of MB/s: **3.8× faster training** and **116× faster encoding** than HuggingFace `tokenizers`, on a SuperBPE that packs ~20% more text into every token.*
